...
def group_text(tokenizer, out_file, max_len, sft=False, no_grouping=False, no_padding=False, args=None):
    ...
    for file in train_files:
        ...
        # shuffle the dataset for the balance_datasets function
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dpo", action="store_true", help="Run for DPO data")
    parser.add_argument("--out_file_path", type=str, default=None, help="Path to output grouped parquet file") 
    parser.add_argument("--model_path", type=str, default="meta-llama/Meta-Llama-3-8B", help="Tokenizer path")
